...
- advertise less or more effectively (not elaborated)

- understanding the boundaries of the enterprise
      partnership marketing
      finding connections  (not elaborated, except orphan drugs example)
      bridging gaps  (not elaborated)
      patent and other types of monitoring 

- On a different level he mentioned 'signals vs goals' but again I'm not sure how he operationalizes this distinction. 
...
- the small bottlers producing long tail products -- I see two opportunities: moving niche to mainstream based on data, and putting the analytics data in front of the small bottlers (we tried to do it with bread distributors earlier, so it might be uphill, but who knows, given the ownership of the process is more concentrated). 
